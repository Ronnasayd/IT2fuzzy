...
class IT2output{
    ...
    public:std::vector<IT2membership*> memberships;
...
class IT2outputs{
    ...
    public:std::vector<IT2output*> foutputs;

    public:IT2outputs(IT2output *m,...){
        va_list lt;
        va_start(lt,m);
        IT2output * aux;
...
class IT2input{
    ...
    public:IT2input(double init, double fin,IT2membership *m,...){
        this->initial_value = init;
        this->final_value = fin;
        va_list lt;
        va_start(lt,m);
...
class IT2inputs{
    ...
    public:std::vector<IT2input*> finputs;

    public:IT2inputs(IT2input *m,...){
        va_list lt;
        va_start(lt,m);
        IT2input * aux;
